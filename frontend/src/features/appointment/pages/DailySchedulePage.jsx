    ...
    <div className="px-4 py-8 min-h-screen to-blue-50 bg-linear-to-br from-slate-50">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-7">
          ...
          <p className="mt-1 text-sm text-slate-500">View your appointments for any selected day.</p>
        </div>
          ...
          <div className="md:col-span-3">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-20 shrink-0 text-center pt-0.5">
                          ...
                          {isCurrent && (
                            <span className="text-xs font-medium text-blue-500">Now</span>
                          )}
                          {isNext && (
                            <span className="text-xs font-medium text-yellow-600">Next</span>
                          )}
                        </div>
                        ...
                        <div className="flex flex-col items-center pt-1.5">
                          <div className={`w-3 h-3 rounded-full border-2 ${
                            ...
                            isNext    ? "bg-yellow-300 border-yellow-400" :
                                        "bg-white border-slate-300"
                          }`} />
                          <div className="flex-1 mt-1 w-px bg-slate-200" />
                        </div>
            ...
            <div className="flex gap-4 mt-3 text-xs text-slate-500">
              <span className="flex items-center gap-1.5">
                <span className="inline-block w-3 h-3 bg-blue-500 rounded" /> Current
              </span>
              <span className="flex items-center gap-1.5">
                <span className="inline-block w-3 h-3 bg-yellow-400 rounded" /> Next
              </span>
              <span className="flex items-center gap-1.5">
